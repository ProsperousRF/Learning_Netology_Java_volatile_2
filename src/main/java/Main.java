...
public class Main {
  ...
  private static final int MAX_SALES = 1_000;
  ...
  public static void main(String[] args) throws ExecutionException, InterruptedException {
    ...
    for (int[] array : arrays) {
      sum.addAndGet(executorService.submit(new Counter(array)).get());
    }
    executorService.shutdown();
    System.out.println("Выручка по всем магазинам: " + sum.get());
  }
}
